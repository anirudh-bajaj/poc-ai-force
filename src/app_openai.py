...
from similarity_engine_openai import CSVCosineSimilarity
...
st.set_page_config(page_title="Cosine Similarity Tool", layout="wide")
...
if st.button("🔍 Compare"):
    ...
    engine = CSVCosineSimilarity(openai_api_key=OPENAI_API_KEY)

    with st.spinner("Comparing rows using embeddings..."):
